...
It shows how we can take data directly from the SOAP catalogues, or we can manually calculate properties from the snapshots using tools such as SWIFTGalaxy.
...
Briefly, TimeSHAP is a feature attribution framework that allows for the relative importance of individual features, time steps, or a combination of features at a given time step, in influencing the model's predictions for target variable - in this case SMBH mass at fixed binding energy at z=0.
